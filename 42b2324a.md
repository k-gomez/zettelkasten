---
date: 2022-01-28T07:02
---

# JSON-LD
Parent: [[e92797f6]]

Data representation used in [[e92797f6]]

For example, an example for raw data:
```json
{
    "@context": {
